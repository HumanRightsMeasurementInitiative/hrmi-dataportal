...
export const scope = 'hrmi.BehindTheNumbers.China.Sfs';
...
export default defineMessages({
  ...
  arrestHeader: {
    ...
    defaultMessage:
      'Right to Freedom from Arbitray Arrest and Detention in East Asia',
  },
  disappearanceHeader: {
    id: `${scope}.disappearanceHeader`,
    defaultMessage: 'Right to Freedom from Forced Disappearance in East Asia',
  },
  deathPenaltyHeader: {
    id: `${scope}.deathPenaltyHeader`,
    defaultMessage: 'Right to Freedom from Death Penalty in East Asia',
  },
  extraJudKillingHeader: {
    id: `${scope}.extraJudKillingHeader`,
    defaultMessage:
      'Right to Freedom from Extrajudicial Execution in East Asia',
  },
  tortureHeader: {
